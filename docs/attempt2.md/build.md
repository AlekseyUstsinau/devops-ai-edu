...
> Your task is to transform the following high-level requirement into a complete, ready-to-execute Jira Ticket for a devops engineer to provision infrastructure in AWS.
> 
...
### Step 4.5 Create Jira ticket

Ask LLM to create JIRA ticket if accesses are configured, or create it manually
